...
const Newsletter = () => {
  ...
  return (
    <section id="contact" className="py-12 bg-muted border-t border-border">
            ...
            <div className="sm:col-span-2">
              <label className="flex items-start gap-3 cursor-pointer">
                <div className="relative mt-0.5">
                  ...
                  />
                  <div className="w-5 h-5 border border-border peer-checked:bg-primary peer-checked:border-primary transition-colors flex items-center justify-center rounded-sm">
